...
> 一个 202 篇的深度解读系列:逐文件、逐模块地读这个复刻项目里**真实存在的**代码与资源。
...
**换舵机与电压 · 48 篇**——"换成别的舵机怎么改?电压不一样怎么改?"的完整答案:
...
- **第十七辑 201–202 换舵机实战案例精读(外部)**:另一台机器 XL330→HD-1910 的完整适配与训练,方法论、结果收紧与不能照搬清单([解读 201](201-案例精读上-他们改了什么.md) 起)
...
| # | 标题 | 解读对象 |
|---|---|---|
| 201 | [案例精读(上):把 XL330 换成 HD-1910,他们改了什么](201-案例精读上-他们改了什么.md) | HD-1910 迁移训练审计报告(已归档 `docs/research/`)§1–§5、§11 |
| 202 | [案例精读(下):结果怎么读,哪些不能照搬](202-案例结果与教训.md) | 同报告 §12–§14 + 本仓库已落地实现对照 |
